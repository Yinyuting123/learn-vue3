...
<img src="https://cn.vitejs.dev/assets/bundler.37740380.png" style="width: 500px; height: 280px; float: left; zoom: 150%;" />

<img src="https://cn.vitejs.dev/assets/esm.3070012d.png" style="width: 480px; height: 280px; zoom: 150%;" />
...
- watch时value的问题：
  ...
  此处这里为什么使用person.value,因为ref底层借用了reactive实现对象的响应式，refImpl的value中是Proxy对象，

  使用value则直接监听了Proxy对象，watch有效

  如果不使用value，改变person属性，Proxy对象地址并未发生变化，即watch监视不到。

![image-20240111172940790](https://yyt-picgo.oss-cn-hangzhou.aliyuncs.com/img/202401111729945.png)
...
<div style="border:1px solid black;width:510px;height:985px;float:left">
  ...
  <img src="https://cn.vuejs.org/assets/lifecycle.DLmSwRQE.png" alt="lifecycle_2" style="zoom:50%;width:2500px" />
</div>
